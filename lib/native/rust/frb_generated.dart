...
abstract class RustLibApi extends BaseApi {
  ...
  Future<String> crateApiSmartSortPlanSmartSortJson({
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_f_64(climaxPosition, serializer);
          sse_encode_f_64(contrast, serializer);
          sse_encode_usize(takeCount, serializer);
          sse_encode_f_64(smoothness, serializer);
          sse_encode_i_32(outroStyle, serializer);
          sse_encode_i_32(taste, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 44,
        ...
        constMeta: kCrateApiSmartSortPlanSmartSortJsonConstMeta,
        argValues: [
          payloadJson,
          climaxPosition,
          contrast,
  ...
  TaskConstMeta get kCrateApiSmartSortPlanSmartSortJsonConstMeta =>
      const TaskConstMeta(
        debugName: 'plan_smart_sort_json',
        argNames: [
          'payloadJson',
          'climaxPosition',
          'contrast',
      ...
      handler.executeNormal(
        NormalTask(
          callFfi: (port_) {
            final serializer = SseSerializer(generalizedFrbRustBinding);
            sse_encode_String(indexPath, serializer);
            sse_encode_bool(forceMetadataCheck, serializer);
            sse_encode_StreamSink_index_action_state_Sse(sink, serializer);
            pdeCallFfi(
              generalizedFrbRustBinding,
              serializer,
          ...
          argValues: [indexPath, forceMetadataCheck, sink],
          apiImpl: this,
        ),
      ),
    );
  ...
  TaskConstMeta get kCrateApiTagReaderUpdateIndexConstMeta =>
      const TaskConstMeta(
        ...
        argNames: ['indexPath', 'forceMetadataCheck', 'sink'],
      );
  ...
  IndexAudio dco_decode_index_audio(dynamic raw) {
    ...
    return IndexAudio(
      ...
      duration: dco_decode_u_64(arr[6]),
      bitrate: dco_decode_opt_box_autoadd_u_32(arr[7]),
      sampleRate: dco_decode_opt_box_autoadd_u_32(arr[8]),
      path: dco_decode_String(arr[9]),
      modified: dco_decode_u_64(arr[10]),
      created: dco_decode_u_64(arr[11]),
      by: dco_decode_opt_String(arr[12]),
      playCount: dco_decode_i_64(arr[13]),
    );
  }
